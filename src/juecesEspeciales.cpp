...
bool rango(string archSalidaEsperada, string archAlum)
{
    ofstream cout("logRango.txt", fstream::app);
...
bool conjunto(string archSalidaEsperada, string archAlum)
{
    ofstream cout("logConjunto.txt", fstream::app);
